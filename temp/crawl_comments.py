...
result = []
for pid in tqdm(p_ids, total=3): # use tqdm meaning you mangage that process 
    # show type percent(%). calc time run 
    # for loop duyệt even product_id 
    # pid: contain product_id
    params['product_id'] = pid
    print('Crawl comment for product {}'.format(pid))
    for i in range(2):# run 2 page thôi anything esle very much
        params['page'] = i  
